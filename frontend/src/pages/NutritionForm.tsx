      ...
      <AnimatePresence mode="wait" custom={direction}>
        ...
        {step === 0 && (
          <motion.div key="0" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="w-full space-y-6 text-center">
            <h1 className="text-2xl font-bold text-white mb-4">What's your age group?</h1>
              ...
              {AGE_RANGES.map(a => (
                <Card key={a.id} className={cn("cursor-pointer border transition-all duration-300 backdrop-blur-sm group hover:scale-[1.02]",
                  ...
                  <CardContent className="p-6 flex flex-col items-center gap-3">
                    <a.icon className={cn("w-8 h-8 transition-colors", formData.ageGroup === a.id ? "text-primary flex-shrink-0" : "text-white/70 group-hover:text-white")} />
                    <div>
                      <div className={cn("font-bold transition-colors", formData.ageGroup === a.id ? "text-primary" : "text-white/90")}>{a.label}</div>
                      <div className={cn("text-xs transition-colors", formData.ageGroup === a.id ? "text-primary/70" : "text-white/50")}>{a.description}</div>
                    </div>
                  </CardContent>
                </Card>
              ))}
        ...
        {step === 1 && (
          <motion.div key="1" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="w-full space-y-4 text-center">
            <h1 className="text-2xl font-bold text-white mb-4">What is your main goal?</h1>
        ...
        {step === 2 && (
          <motion.div key="2" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="w-full space-y-4 text-center">
            <h1 className="text-2xl font-bold text-white mb-4">What motivates you?</h1>
            <div className="flex flex-col gap-3">
              {MOTIVATIONS.map(m => (
                <Button key={m.id} variant="ghost" className={cn("h-16 justify-start text-lg px-6 gap-3 border transition-all duration-300 backdrop-blur-sm",
                  ...
                  <m.icon className={cn("w-5 h-5", formData.motivation === m.id ? "text-primary" : "text-white/50")} />
        ...
        {step === 3 && (
          <motion.div key="3" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="w-full space-y-4 text-center">
            <h1 className="text-2xl font-bold text-white mb-4">Your experience?</h1>
            <div className="flex flex-col gap-3">
              {EXPERIENCES.map(e => (
        ...
        {step === 4 && (
          <motion.div key="4" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="w-full space-y-4 text-center">
            <h1 className="text-2xl font-bold text-white mb-4">How do you feel about starting?</h1>
            <div className="flex flex-col gap-3">
              {FEELINGS.map(f => (
        ...
        {step === 5 && (
          <motion.div key="5" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="w-full space-y-4 text-center">
              ...
              {CHALLENGES.map(c => {
                ...
                return (
                  <div key={c.id} className={cn("flex items-center p-4 border rounded-xl cursor-pointer transition-all duration-300 backdrop-blur-sm",
                    ...
                    <div className={cn("w-6 h-6 rounded-full border flex items-center justify-center transition-colors", active ? "bg-primary border-primary text-white" : "border-white/30")}>
            ...
            <div className="flex justify-between pt-4">
              <Button variant="ghost" onClick={prevStep} className="text-white/60 hover:text-white hover:bg-white/10"><ChevronLeft className="w-4 h-4 mr-2" /> Back</Button>
        ...
        {step === 6 && (
          <motion.div key="6" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="w-full space-y-4 text-center">
            <h1 className="text-2xl font-bold text-white mb-2">How to stay on track?</h1>
            <div className="flex flex-col gap-3">
              {STRATEGIES.map(s => {
        ...
        {step === 12 && (
          <motion.div key="12" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="w-full space-y-4 text-center">
            <h1 className="text-2xl font-bold text-white mb-4">Activity Level</h1>
            <div className="flex flex-col gap-3">
              {[
                ...
                <div key={a.id} className={cn("text-left p-4 border rounded-xl cursor-pointer transition-all duration-300 backdrop-blur-sm group",
                  ...
                  <div className={cn("font-bold text-lg mb-1 transition-colors", formData.activityLevel === a.id ? "text-primary" : "text-white")}>{a.label}</div>
                  <div className={cn("text-sm transition-colors", formData.activityLevel === a.id ? "text-primary/70" : "text-white/60")}>{a.desc}</div>
                </div>
              ))}
            </div>
            <Button variant="ghost" onClick={prevStep} className="mt-4 text-white/60 hover:text-white hover:bg-white/10"><ChevronLeft className="w-4 h-4 mr-2" /> Back</Button>
          </motion.div>
        )}
        ...
        {step === 13 && (
          <motion.div key="13" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="w-full space-y-4 text-center">
            <h1 className="text-2xl font-bold text-white mb-4">Diet Preferences</h1>
